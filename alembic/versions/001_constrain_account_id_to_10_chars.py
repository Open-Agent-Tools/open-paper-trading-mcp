...
def upgrade() -> None:
    ...
    # Positions table
    op.alter_column('positions', 'account_id',
                    existing_type=sa.String(),
                    type_=sa.String(length=10),
                    existing_nullable=False)
    
    # Orders table
    op.alter_column('orders', 'account_id',
                    existing_type=sa.String(),
                    type_=sa.String(length=10),
                    existing_nullable=False)
    ...
    op.alter_column('multi_leg_orders', 'account_id',
                    existing_type=sa.String(),
                    type_=sa.String(length=10),
                    existing_nullable=False)
    
    # Recognized strategies table
    op.alter_column('recognized_strategies', 'account_id',
                    existing_type=sa.String(),
                    type_=sa.String(length=10),
                    existing_nullable=False)
    
    # Portfolio Greeks snapshots table
    op.alter_column('portfolio_greeks_snapshots', 'account_id',
                    existing_type=sa.String(),
                    type_=sa.String(length=10),
                    existing_nullable=False)

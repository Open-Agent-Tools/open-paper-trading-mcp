...
class QuoteCache:
    ...
    def get(self, key: str) -> Optional[Union[Quote, OptionQuote, OptionsChain, Dict, List]]:
        """
    ...
    def put(self, key: str, value: Union[Quote, OptionQuote, OptionsChain, Dict, List], 
        ...
        with self._lock:
            ...
            for key, entry in self._cache.items():
                entries.append({
                    ...
                    'ttl': entry.ttl,
                    'remaining_ttl': max(0, entry.ttl - (current_time - entry.timestamp)),
...
class CachedQuoteAdapter:
    ...
    def get_options_chain(self, underlying: str, expiration = None) -> Optional[OptionsChain]:

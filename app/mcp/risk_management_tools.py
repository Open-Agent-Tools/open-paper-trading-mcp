...
async def calculate_position_sizing(
    symbol: str, account_risk_percent: float, stop_loss_price: float, entry_price: float
) -> dict[str, Any]:
    """
...
async def check_risk_limits() -> dict[str, Any]:
    ...
    try:
        ...
        data = {
            ...
            if limit_violations
            else ["Portfolio within risk limits"],
    ...
    try:
        ...
        data = {
            ...
            "margin_requirements": {
                ...
                "house_minimum": house_requirement
                if order_type == "buy"
                else sma_requirement,
            ...
            "warnings": [
                ...
                if day_trading_buying_power < buying_power_required
                else None,
            ],
            "calculation_date": datetime.now().isoformat(),
        }
    ...
    try:
        ...
        data = {
            ...
            "recovery_analysis": {
                ...
                "recovery_rate_required": round(
                    (peak_value / current_value - 1) * 100, 2
                ),
            },
            ...
            "risk_assessment": {
                ...
                "recovery_outlook": "challenging"
                if days_in_drawdown > 90
                else "moderate",

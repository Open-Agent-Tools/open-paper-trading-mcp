...
class Option(Asset):
    ...
    def __init__(self, symbol: str = None, underlying: Union[str, Asset] = None, 
                 option_type: str = None, strike: float = None, 
                 expiration_date: Union[str, date, datetime] = None, **data):
        ...
        if symbol is not None:
            ...
            underlying_asset = asset_factory(underlying) if not isinstance(underlying, Asset) else underlying
            ...
            built_symbol = f"{underlying_asset.symbol}{exp_str}{option_char}{strike_str}"
    ...
    def get_extrinsic_value(self, underlying_price: float, option_price: float) -> float:
...
class Call(Option):
    ...
    def __init__(self, symbol: str = None, underlying: Union[str, Asset] = None,
                 strike: float = None, expiration_date: Union[str, date] = None, **data):
        super().__init__(
            symbol=symbol,
            underlying=underlying,
            option_type='call',

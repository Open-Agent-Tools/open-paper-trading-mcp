...
class Position(object):
    ...
    @property
    def underlying(self):
        return self.asset.underlying if isinstance(self.asset, Option) else None
    ...
    def delta(self):
        return (
            (self.quote.delta * self.quantity * self.multiplier)
            if isinstance(self.asset, Option)
            else (1 * self.quantity * self.multiplier)
        )

    @property
    def gamma(self):
        return (
            (self.quote.gamma * self.quantity * self.multiplier)
            if isinstance(self.asset, Option)
            else (0.0)
        )
    ...
    def theta(self):
        return (
            (self.quote.theta * self.quantity * self.multiplier)
            if isinstance(self.asset, Option)
            else (0.0)
        )
    ...
    def vega(self):
        return (
            (self.quote.vega * self.quantity * self.multiplier)
            if isinstance(self.asset, Option)
            else (0.0)
        )
    ...
    def rho(self):
        return (
            (self.quote.rho * self.quantity * self.multiplier)
            if isinstance(self.asset, Option)
            else (0.0)
        )
    ...
    def iv(self):
        return (
            (self.quote.iv * self.quantity * self.multiplier)
            if isinstance(self.asset, Option)
            else (0.0)
        )
    ...
    def total_price(self):
        return (
            (self.quote.price * self.quantity * self.multiplier)
            if isinstance(self.asset, Option) and self.quote is not None
            else (0.0)
        )

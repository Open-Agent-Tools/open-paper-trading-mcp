...
class TestClosingExpiredOptions(unittest.TestCase):
    ...
    def test_will_not_close_if_not_expired(self):
        ...
        account = Account(
            [
                Position(
                    asset="AAL170127P00048000",
                    quantity=-1,
                    cost_basis=(0.65 + 0.74) / 2,
                )
            ]
        )
    ...
    def test_itm_long_call(self):
        ...
        account = Account(
            [
                Position(
                    asset="AAL170127C00046000", quantity=1, cost_basis=(1.30 + 1.46) / 2
                )
            ]
        )
        account.cash = 10000
    ...
    def test_itm_long_put(self):
        ...
        account = Account(
            [
                Position(
                    asset="AAL170127P00048000", quantity=1, cost_basis=(0.65 + 0.74) / 2
                )
            ]
        )
        account.cash = 10000
    ...
    def test_itm_short_naked_call(self):
        ...
        account = Account(
            [
                Position(
                    asset="AAL170127C00046000",
                    quantity=-1,
                    cost_basis=(1.30 + 1.46) / 2,
                )
            ]
        )
        account.cash = 10000

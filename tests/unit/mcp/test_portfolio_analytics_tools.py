...
class TestPortfolioAnalyticsTools:
    ...
    async def test_calculate_sharpe_ratio(self, mock_get_service, mock_portfolio):
        ...
        expected_sharpe = (data["annual_return"] - data["risk_free_rate"]) / data[
            "annual_volatility"
        ]
    ...
    @patch("app.mcp.portfolio_analytics_tools.get_trading_service")
    @pytest.mark.asyncio
    async def test_calculate_sharpe_ratio_custom_period(
    ...
    @patch("app.mcp.portfolio_analytics_tools.get_trading_service")
    @pytest.mark.asyncio
    async def test_calculate_var_custom_confidence(
        self, mock_get_service, mock_portfolio
    ):

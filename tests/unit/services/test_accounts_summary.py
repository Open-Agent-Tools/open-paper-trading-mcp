...
class TestGetAllAccountsSummary:
    ...
    async def test_get_all_accounts_summary_empty_database(
    ...
    async def test_get_all_accounts_summary_single_account(
        self, db_session: AsyncSession
    ):
    ...
    async def test_get_all_accounts_summary_multiple_accounts(
        self, db_session: AsyncSession
    ):
    ...
    async def test_get_all_accounts_summary_return_types(
        self, db_session: AsyncSession
    ):

...
from app.schemas.orders import Order, OrderStatus
...
class TestOrderLifecycleManager:
    ...
    def test_create_order_duplicate_id(self):
        ...
        with pytest.raises(
            OrderLifecycleError, match="Order test_order_123 already exists"
        ):
    ...
    def test_transition_order_not_found(self):
        ...
        with pytest.raises(OrderLifecycleError, match="Order nonexistent not found"):
            self.manager.transition_order(
                "nonexistent", OrderStatus.FILLED, OrderEvent.FILLED
            )
    ...
    def test_update_fill_details_success(self):
        ...
        result = self.manager.update_fill_details(
            "test_order_123", filled_quantity=50, fill_price=150.0, commission=1.0
        )
    ...
    def test_update_fill_details_complete_fill(self):
        ...
        # Fill completely
        result = self.manager.update_fill_details(
            "test_order_123", filled_quantity=100, fill_price=150.0, commission=2.0
        )
    ...
    def test_update_fill_details_multiple_fills(self):
        ...
        self.manager.update_fill_details(
            "test_order_123", filled_quantity=30, fill_price=150.0, commission=1.0
        )

        # Second partial fill
        result = self.manager.update_fill_details(
            "test_order_123", filled_quantity=20, fill_price=155.0, commission=1.0
        )
    ...
    def test_update_fill_details_order_not_found(self):
        ...
        with pytest.raises(OrderLifecycleError, match="Order nonexistent not found"):
            self.manager.update_fill_details(
                "nonexistent", filled_quantity=50, fill_price=150.0
            )
    ...
    def test_cancel_order_success(self):
        ...
        result = self.manager.cancel_order(
            "test_order_123", reason="User requested", triggered_by="user"
        )
    ...
    def test_cancel_order_cannot_cancel(self):
        ...
        with pytest.raises(
            OrderLifecycleError, match="Order test_order_123 cannot be cancelled"
        ):
    ...
    def test_reject_order_success(self):
        ...
        result = self.manager.reject_order(
            "test_order_123", reason="Insufficient funds", triggered_by="risk_engine"
        )
    ...
    def test_expire_order_success(self):
        ...
        result = self.manager.expire_order(
            "test_order_123", reason="End of day", triggered_by="time_engine"
        )
    ...
    def test_trigger_order_success(self):
        ...
        result = self.manager.trigger_order(
            "test_order_123", trigger_price=145.0, triggered_by="market"
        )
    ...
    def test_get_orders_by_status(self):
        ...
        self.manager.transition_order(
            "order_1", OrderStatus.CANCELLED, OrderEvent.CANCELLED
        )
    ...
    def test_cleanup_completed_orders(self):
        ...
        for i in range(5):
            ...
            self.manager.create_order(order)
            self.manager.transition_order(
                f"order_{i}", OrderStatus.FILLED, OrderEvent.FILLED
            )
    ...
    def test_get_statistics(self):
        ...
        self.manager.transition_order(
            "order_2", OrderStatus.PARTIALLY_FILLED, OrderEvent.PARTIALLY_FILLED
        )
    ...
    def test_is_valid_transition(self):
        ...
        # Valid transitions
        assert self.manager._is_valid_transition(
        ...
        # Invalid transitions
        assert not self.manager._is_valid_transition(
    ...
    def test_update_lifecycle_flags(self):
        ...
        self.manager.transition_order(
            "test_order_123", OrderStatus.PARTIALLY_FILLED, OrderEvent.PARTIALLY_FILLED
        )
...
class TestOrderLifecycleManagerPerformance:
    ...
    def test_large_number_of_orders(self):
        ...
        for i in range(1000):
            ...
            if i % 10 == 0:
                self.manager.transition_order(
                    f"bulk_order_{i}", OrderStatus.FILLED, OrderEvent.FILLED
                )
...
class TestOrderLifecycleManagerErrorScenarios:
    ...
    def test_zero_quantity_fills(self):
        ...
        result = self.manager.update_fill_details(
            "test_order", filled_quantity=0, fill_price=150.0
        )
        ...
        assert result.remaining_quantity == 100
        assert (
            result.current_status == OrderStatus.PENDING
        )  # No transition for zero fill
    ...
    def test_concurrent_state_modifications(self):
        ...
        def fill_order(fill_size):
            try:
                result = self.manager.update_fill_details(
                    "concurrent_test", filled_quantity=fill_size, fill_price=150.0
                )

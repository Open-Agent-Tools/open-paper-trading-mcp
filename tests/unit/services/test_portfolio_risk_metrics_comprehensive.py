...
class TestPortfolioRiskCalculator:
    ...
    def test_calculate_portfolio_risk_with_data(
        self, sample_portfolio, sample_historical_data
    ):
...
class TestDataClasses:
    ...
    def test_portfolio_risk_summary(self):
        ...
        var_results = {0.95: VaRResult(0.95, 1, 5000.0, 0.05, 6000.0, "historical")}
...
class TestErrorHandling:
    ...
    def test_var_calculation_with_insufficient_data(self):
        ...
        result = calculator.calculate_portfolio_risk(portfolio, historical_data)
...
class TestIntegrationScenarios:
    ...
    def test_monte_carlo_simulation_scenario(self, mock_random, diversified_portfolio):
        ...
        result = calculator.calculate_portfolio_risk(
            diversified_portfolio, historical_data=historical_data
        )

...
class TestTradingServiceMultiLegAdvanced:
    ...
    @pytest.mark.asyncio
    async def test_create_multi_leg_order_from_request_basic_spread(self, trading_service_test_data):
        ...
        with patch.object(trading_service_test_data, 'create_multi_leg_order', return_value=mock_order) as mock_create:
            result = await trading_service_test_data.create_multi_leg_order_from_request(
                legs=legs,
                order_type="limit",
                net_price=2.50
            )
    ...
    @pytest.mark.asyncio
    async def test_create_multi_leg_order_from_request_market_order(self, trading_service_test_data):
    ...
    @pytest.mark.asyncio
    async def test_create_multi_leg_order_from_request_complex_iron_condor(self, trading_service_test_data):
    ...
    @pytest.mark.asyncio
    async def test_create_multi_leg_order_from_request_single_leg(self, trading_service_test_data):
    ...
    @pytest.mark.asyncio
    async def test_create_multi_leg_order_from_request_empty_legs(self, trading_service_test_data):
    ...
    @pytest.mark.asyncio
    async def test_create_multi_leg_order_from_request_mixed_quantities(self, trading_service_test_data):
    ...
    @pytest.mark.asyncio
    async def test_create_multi_leg_order_from_request_missing_required_fields(self, trading_service_test_data):
    ...
    @pytest.mark.asyncio
    async def test_create_multi_leg_order_from_request_invalid_order_type(self, trading_service_test_data):
    ...
    @pytest.mark.asyncio
    async def test_create_multi_leg_order_from_request_zero_net_price(self, trading_service_test_data):
        """Test creating multi-leg order with zero net price."""
        legs = [
            {"symbol": "SPY240315C00400000", "quantity": 1, "side": "buy"},
            {"symbol": "SPY240315C00400000", "quantity": 1, "side": "sell"}  # Perfect hedge
        ]
    ...
    @pytest.mark.asyncio
    async def test_create_multi_leg_order_from_request_negative_net_price(self, trading_service_test_data):
    ...
    @pytest.mark.asyncio
    async def test_create_multi_leg_order_from_request_large_quantities(self, trading_service_test_data):
    ...
    @pytest.mark.asyncio
    async def test_create_multi_leg_order_from_request_underlying_create_error(self, trading_service_test_data):
        """Test error handling when underlying create_multi_leg_order fails."""
        legs = [
            {"symbol": "INVALID240315C00150000", "quantity": 1, "side": "buy"}
        ]
        
        with patch.object(trading_service_test_data, 'create_multi_leg_order') as mock_create:
    ...
    @pytest.mark.asyncio
    async def test_create_multi_leg_order_from_request_preserves_leg_order(self, trading_service_test_data):
    ...
    @pytest.mark.asyncio
    async def test_create_multi_leg_order_from_request_different_sides_validation(self, trading_service_test_data):
    ...
    @pytest.mark.asyncio
    async def test_create_multi_leg_order_from_request_comprehensive_structure_validation(self, trading_service_test_data):
        """Test comprehensive validation of structured legs output."""
        legs = [
            {"symbol": "TEST240315C00100000", "quantity": 5, "side": "buy"}
        ]

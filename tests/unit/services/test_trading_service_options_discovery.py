...
class TestTradingServiceOptionsDiscovery:
    ...
    async def test_find_tradable_options_basic_success(self, trading_service_test_data):
        ...
        with patch.object(trading_service_test_data.quote_adapter, 'get_chain', return_value=mock_options):
    ...
    @pytest.mark.asyncio
    async def test_find_tradable_options_with_strike_filter(self, trading_service_test_data):
    ...
    @pytest.mark.asyncio
    async def test_find_tradable_options_calls_only_filter(self, trading_service_test_data):
    ...
    @pytest.mark.asyncio
    async def test_find_tradable_options_puts_only_filter(self, trading_service_test_data):
    ...
    @pytest.mark.asyncio
    async def test_find_tradable_options_combined_filters(self, trading_service_test_data):
    ...
    @pytest.mark.asyncio
    async def test_find_tradable_options_no_expiration_date(self, trading_service_test_data):
    ...
    @pytest.mark.asyncio
    async def test_find_tradable_options_no_options_found(self, trading_service_test_data):
    ...
    async def test_find_tradable_options_adapter_error(self, trading_service_test_data):
        ...
        with patch.object(trading_service_test_data.quote_adapter, 'get_chain') as mock_get_chain:
    ...
    @pytest.mark.asyncio
    async def test_find_tradable_options_invalid_strike_range(self, trading_service_test_data):
    ...
    @pytest.mark.asyncio
    async def test_get_market_hours_with_extended_adapter(self, trading_service_test_data):
        ...
        with patch.object(trading_service_test_data.quote_adapter, 'get_market_hours', return_value=mock_hours):
    ...
    @pytest.mark.asyncio
    async def test_get_market_hours_fallback_basic_info(self, trading_service_test_data):
    ...
    async def test_get_market_hours_adapter_error(self, trading_service_test_data):
        ...
        with patch.object(trading_service_test_data.quote_adapter, 'get_market_hours') as mock_hours:
    ...
    @pytest.mark.asyncio
    async def test_find_tradable_options_response_structure_validation(self, trading_service_test_data):
        ...
        with patch.object(trading_service_test_data.quote_adapter, 'get_chain', return_value=mock_options):
            ...
            required_fields = ["underlying", "expiration_date", "options", "filters_applied"]
            for field in required_fields:
                assert field in result
            
            # Verify option structure
            option = result["options"][0]
            required_option_fields = ["symbol", "option_type", "strike", "expiration_date", "underlying_symbol"]
    ...
    @pytest.mark.asyncio
    async def test_find_tradable_options_edge_case_zero_strike(self, trading_service_test_data):
    ...
    @pytest.mark.asyncio
    async def test_find_tradable_options_very_high_strikes(self, trading_service_test_data):

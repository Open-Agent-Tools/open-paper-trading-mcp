...
class TestRobinhoodConfig:
    ...
    def test_explicit_initialization(self):
        ...
        config = RobinhoodConfig(
            username="test_user", password=SecretStr("test_password"), expires_in=3600
        )
    ...
    def test_has_credentials_true(self):
        ...
        config = RobinhoodConfig(
            username="test_user", password=SecretStr("test_password")
        )
    ...
    def test_get_password_with_password(self):
        ...
        config = RobinhoodConfig(password=SecretStr("secret_password_123"))
    ...
    def test_secret_str_security(self):
        ...
        config = RobinhoodConfig(
            username="test_user", password=SecretStr("very_secret_password")
        )
    ...
    def test_secret_str_repr_security(self):
        ...
        config = RobinhoodConfig(password=SecretStr("super_secret_password"))
    ...
    def test_explicit_values_override_environment(self):
        ...
        with patch.dict(os.environ, env_vars):
            config = RobinhoodConfig(
                username="explicit_user", password=SecretStr("explicit_password")
            )
    ...
    def test_invalid_expires_in_type(self):
        ...
        env_vars = {"ROBINHOOD_EXPIRES_IN": "not_a_number"}

        with patch.dict(os.environ, env_vars), pytest.raises(ValidationError):
            RobinhoodConfig()
    ...
    def test_empty_string_credentials(self):
        ...
        config = RobinhoodConfig(username="", password=SecretStr(""))
    ...
    def test_unicode_credentials(self):
        ...
        config = RobinhoodConfig(
            username="user_测试", password=SecretStr("password_密码")
        )
    ...
    def test_long_credentials(self):
        ...
        config = RobinhoodConfig(
            username=long_username, password=SecretStr(long_password)
        )
    ...
    def test_special_characters_in_credentials(self):
        ...
        config = RobinhoodConfig(
            username=special_username, password=SecretStr(special_password)
        )
...
class TestRobinhoodConfigSecurity:
    ...
    def test_password_not_logged_in_dict(self):
        ...
        config = RobinhoodConfig(
            username="test_user", password=SecretStr("super_secret_password")
        )
    ...
    def test_password_excluded_from_json_serialization(self):
        ...
        config = RobinhoodConfig(
            username="test_user", password=SecretStr("secret_password")
        )
    ...
    def test_memory_cleanup_behavior(self):
        ...
        config = RobinhoodConfig(password=SecretStr("temporary_password"))
    ...
    def test_password_immutability(self):
        ...
        config = RobinhoodConfig(password=SecretStr("original_password"))
...
class TestRobinhoodConfigValidation:
    ...
    def test_configuration_immutability_after_creation(self):
        ...
        config = RobinhoodConfig(
            username="original_user", password=SecretStr("original_password")
        )
...
class TestRobinhoodConfigErrorHandling:
    ...
    def test_invalid_environment_variable_types(self):
        ...
        env_vars = {"ROBINHOOD_EXPIRES_IN": "definitely_not_a_number"}
...
class TestRobinhoodConfigEdgeCases:
    ...
    def test_very_long_environment_variables(self):
        ...
        long_value = "x" * 10000
        env_vars = {"ROBINHOOD_USERNAME": long_value}
    ...
    def test_environment_variables_with_newlines(self):
        ...
        env_vars = {"ROBINHOOD_USERNAME": "user\nwith\nnewlines"}

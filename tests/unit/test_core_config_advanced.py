...
class TestSettingsConfiguration:
    ...
    def test_database_url_configuration(self):
        ...
        test_settings = Settings()
        expected_default = "postgresql+asyncpg://trading_user:trading_password@db:5432/trading_db"
        assert test_settings.DATABASE_URL == expected_default
        
        # Test custom database URL override
        custom_db_url = "postgresql+asyncpg://custom_user:custom_pass@custom_host:5433/custom_db"
    ...
    def test_redis_configuration(self):
        ...
        with patch.dict(os.environ, {"REDIS_URL": custom_redis_url}, clear=False):
            test_settings = Settings()
            assert test_settings.REDIS_URL == custom_redis_url
    ...
    def test_security_configuration(self):
        ...
        with patch.dict(os.environ, {"SECRET_KEY": custom_secret}, clear=False):
            test_settings = Settings()
            assert test_settings.SECRET_KEY == custom_secret
    ...
    def test_test_data_configuration(self):
        ...
        with patch.dict(os.environ, {
            "TEST_SCENARIO": "volatility_spike",
            "TEST_DATE": "2020-03-16"
        }, clear=False):
            test_settings = Settings()
...
class TestCORSOriginsValidator:
    ...
    def test_cors_origins_json_array_string(self):
        ...
        with patch.dict(os.environ, {"BACKEND_CORS_ORIGINS": cors_json}, clear=False):
            ...
            assert test_settings.BACKEND_CORS_ORIGINS == cors_json
    ...
    def test_cors_origins_single_value(self):
        ...
        with patch.dict(os.environ, {"BACKEND_CORS_ORIGINS": "http://localhost:3000"}, clear=False):
            test_settings = Settings()
...
class TestConfigurationEdgeCases:
    ...
    def test_boolean_conversion_comprehensive(self):
        ...
        for pattern in true_patterns:
            with patch.dict(os.environ, {"DEBUG": pattern}, clear=False):
                test_settings = Settings()
                assert test_settings.DEBUG is True, f"Pattern '{pattern}' should be True"
    ...
    def test_configuration_immutability_patterns(self):
        ...
        assert test_settings.PROJECT_NAME == original_project_name

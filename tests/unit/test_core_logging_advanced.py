...
class TestDefaultLogDirectoryResolution:
    ...
    def test_linux_non_root_log_directory(self, mock_geteuid, mock_platform):
        ...
        expected_path = Path.home() / ".local" / "state" / "open-paper-trading-mcp" / "logs"
        result = get_default_log_dir()
    ...
    def test_windows_log_directory(self, mock_platform):
        ...
        expected_path = Path.home() / "AppData" / "Local" / "open-paper-trading-mcp" / "logs"
        result = get_default_log_dir()
...
class TestLoggingHandlerConfiguration:
    ...
    def test_file_handler_configuration(self, mock_settings, mock_mkdir, 
                                      mock_rotating_handler, mock_get_logger):
    ...
    @patch('pathlib.Path.mkdir')
    @patch('app.core.config.settings')
    def test_stderr_handler_configuration(self, mock_settings, mock_mkdir,
                                        mock_rotating_handler, mock_stream_handler,
                                        mock_get_logger):
    ...
    @patch('pathlib.Path.mkdir')
    @patch('app.core.config.settings')
    def test_handler_level_setting(self, mock_settings, mock_mkdir,
                                  mock_rotating_handler, mock_get_logger):
    ...
    @patch('pathlib.Path.mkdir')
    @patch('app.core.config.settings')
    def test_formatter_configuration(self, mock_settings, mock_mkdir,
                                   mock_rotating_handler, mock_get_logger):
...
class TestLoggerCleanupAndInitialization:
    ...
    @patch('pathlib.Path.mkdir')
    @patch('app.core.config.settings')
    def test_existing_handlers_removed(self, mock_settings, mock_mkdir,
                                      mock_rotating_handler, mock_get_logger):
    ...
    @patch('pathlib.Path.mkdir')
    @patch('app.core.config.settings')
    def test_project_logger_configuration(self, mock_settings, mock_mkdir,
                                         mock_rotating_handler, mock_get_logger):
...
class TestLogDirectoryCreation:
    ...
    @patch('logging.handlers.RotatingFileHandler')
    @patch('app.core.config.settings')
    def test_log_directory_created(self, mock_settings, mock_rotating_handler, mock_get_logger):
    ...
    @patch('pathlib.Path.mkdir')
    @patch('app.core.config.settings')
    def test_log_file_path_resolution(self, mock_settings, mock_mkdir,
                                     mock_rotating_handler, mock_get_logger):
        ...
        with patch('logging.StreamHandler'), \
            ...
            mock_log_dir.__truediv__.assert_called_once_with("open-paper-trading-mcp.log")
...
class TestLoggingIntegration:
    ...
    @patch('pathlib.Path.mkdir')
    @patch('app.core.config.settings')
    def test_log_messages_during_setup(self, mock_settings, mock_mkdir,
                                      mock_rotating_handler, mock_get_logger):
...
class TestLoggingErrorHandling:
    ...
    @patch('pathlib.Path.mkdir')
    @patch('app.core.config.settings')
    def test_handler_creation_failure_handling(self, mock_settings, mock_mkdir, mock_get_logger):
        ...
        with patch('logging.handlers.RotatingFileHandler', side_effect=OSError("Permission denied")), \
            ...
            try:
                ...
                pytest.fail("setup_logging should handle file handler creation failures gracefully")

    @patch('logging.getLogger')
    @patch('logging.handlers.RotatingFileHandler')
    @patch('app.core.config.settings')
    def test_directory_creation_failure_handling(self, mock_settings, mock_rotating_handler, mock_get_logger):
        ...
        with patch('pathlib.Path.mkdir', side_effect=OSError("Permission denied")), \
            ...
            try:
                ...
                pytest.fail("setup_logging should handle directory creation failures gracefully")

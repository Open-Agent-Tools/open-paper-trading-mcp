...
from app.mcp.tools import (
    ...
    GetPositionArgs, get_stock_quote, create_buy_order, create_sell_order,
    get_all_orders, get_order, cancel_order, get_portfolio,
    get_portfolio_summary, get_all_positions, get_position,
    set_mcp_trading_service, get_mcp_trading_service
)
...
class TestMCPToolErrorHandling:
    ...
    async def test_get_stock_quote_error_handling(self, mock_trading_service):
        ...
        mock_trading_service.get_quote.side_effect = Exception("Quote service unavailable")
        set_mcp_trading_service(mock_trading_service)
    ...
    async def test_portfolio_error_handling(self, mock_trading_service):
        ...
        # Setup service to raise exception
        mock_trading_service.get_portfolio.side_effect = RuntimeError("Database connection failed")
        set_mcp_trading_service(mock_trading_service)
...
class TestMCPServiceDependencyManagement:
    ...
    def test_mcp_trading_service_singleton_pattern(self):
        ...
        from app.mcp.tools import _trading_service

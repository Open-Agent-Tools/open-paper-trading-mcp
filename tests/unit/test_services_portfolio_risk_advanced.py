...
class TestValueAtRiskCalculation:
    ...
    async def test_historical_var_calculation(self, risk_analyzer, diversified_portfolio, mock_market_data):
    ...
    @pytest_asyncio.async_test
    async def test_parametric_var_calculation(self, risk_analyzer, diversified_portfolio, mock_market_data):
    ...
    @pytest_asyncio.async_test
    async def test_monte_carlo_var_calculation(self, risk_analyzer, diversified_portfolio, mock_market_data):
        ...
        with patch.object(risk_analyzer, '_get_correlation_matrix') as mock_corr:
            ...
            with patch.object(risk_analyzer, '_get_portfolio_volatilities') as mock_vols:
    ...
    @pytest_asyncio.async_test
    async def test_conditional_var_calculation(self, risk_analyzer, diversified_portfolio, mock_market_data):
...
class TestExposureMetricsCalculation:
    ...
    def test_basic_exposure_calculation(self, risk_analyzer, diversified_portfolio):
        ...
        expected_gross = sum(abs(pos.market_value) for pos in diversified_portfolio.positions)
    ...
    def test_sector_exposure_calculation(self, risk_analyzer, diversified_portfolio):
        ...
        tech_exposure = (15500 + 26000) / diversified_portfolio.total_value  # AAPL + GOOGL
...
class TestCorrelationAnalysis:
    ...
    @pytest_asyncio.async_test
    async def test_correlation_matrix_calculation(self, risk_analyzer, diversified_portfolio, mock_market_data):
        ...
        with patch.object(risk_analyzer, '_get_returns_data') as mock_returns:
            ...
            corr_matrix = await risk_analyzer.calculate_correlation_matrix(diversified_portfolio)
            ...
            np.testing.assert_array_almost_equal(np.diag(corr_matrix.matrix), np.ones(5))
    ...
    @pytest_asyncio.async_test
    async def test_portfolio_diversification_ratio(self, risk_analyzer, diversified_portfolio, mock_market_data):
        ...
        with patch.object(risk_analyzer, '_get_individual_volatilities') as mock_vols:
            mock_vols.return_value = {
                "AAPL": 0.25, "GOOGL": 0.28, "JPM": 0.32,
                "JNJ": 0.18, "XOM": 0.45
            }
            
            with patch.object(risk_analyzer, '_calculate_portfolio_volatility') as mock_port_vol:
                mock_port_vol.return_value = 0.22  # Portfolio vol less than weighted average
                
                div_ratio = await risk_analyzer.calculate_diversification_ratio(diversified_portfolio)
    ...
    async def test_effective_number_of_bets(self, risk_analyzer, diversified_portfolio):
        ...
        with patch.object(risk_analyzer, '_get_risk_contributions') as mock_contributions:
            # Mock equal risk contributions for diversified portfolio
            mock_contributions.return_value = {
                "AAPL": 0.20, "GOOGL": 0.20, "JPM": 0.20,
                "JNJ": 0.20, "XOM": 0.20
            }
        ...
        with patch.object(risk_analyzer, '_get_risk_contributions') as mock_concentrated:
            mock_concentrated.return_value = {
                "TSLA": 0.80, "AAPL": 0.20  # Concentrated risk
            }
...
class TestRiskDecomposition:
    ...
    @pytest_asyncio.async_test
    async def test_component_var_calculation(self, risk_analyzer, diversified_portfolio, mock_market_data):
        ...
        with patch.object(risk_analyzer, '_calculate_marginal_var') as mock_marginal:
            mock_marginal.return_value = {
                "AAPL": 850.0, "GOOGL": 1200.0, "JPM": 950.0,
                "JNJ": 450.0, "XOM": 1350.0
            }
            
            component_var = await risk_analyzer.calculate_component_var(diversified_portfolio)
            ...
            for symbol, contribution in component_var.components.items():
    ...
    async def test_marginal_var_calculation(self, risk_analyzer, diversified_portfolio):
        ...
        with patch.object(risk_analyzer, 'calculate_parametric_var') as mock_var:
            ...
            mock_var.side_effect = [
                ...
                VaRResult(0.95, 1, 4800.0, 0.048, 6200.0, "parametric")  # After reducing AAPL
            ]
    ...
    @pytest_asyncio.async_test
    async def test_incremental_var_calculation(self, risk_analyzer, diversified_portfolio):
        ...
        with patch.object(risk_analyzer, 'calculate_parametric_var') as mock_var:
            mock_var.side_effect = [
                VaRResult(0.95, 1, 5000.0, 0.05, 6500.0, "parametric"),  # Original
                VaRResult(0.95, 1, 5800.0, 0.052, 7200.0, "parametric")  # With new position
            ]
...
class TestStressTesting:
    ...
    @pytest_asyncio.async_test
    async def test_market_shock_stress_test(self, risk_analyzer, diversified_portfolio, mock_market_data):
        ...
        with patch.object(risk_analyzer, '_apply_market_shock') as mock_shock:
            mock_shock.side_effect = [
                {"portfolio_pnl": -16000.0, "position_impacts": {"AAPL": -3100.0, "GOOGL": -5200.0}},
                {"portfolio_pnl": -8000.0, "position_impacts": {"AAPL": -1550.0, "GOOGL": -2600.0}},
                {"portfolio_pnl": -12000.0, "position_impacts": {"AAPL": -2400.0, "GOOGL": -3800.0}}
            ]
    ...
    @pytest_asyncio.async_test
    async def test_sector_rotation_stress_test(self, risk_analyzer, diversified_portfolio):
    ...
    async def test_tail_risk_scenarios(self, risk_analyzer, diversified_portfolio):
        ...
        tail_scenarios = [
            ...
            {"name": "Flash Crash", "market_drop": -0.09, "volatility_spike": 5.0, "liquidity_shock": 0.5},
            {"name": "Credit Crisis", "market_drop": -0.35, "credit_spread_widening": 0.03}
        ]
...
class TestPerformanceAttribution:
    ...
    @pytest_asyncio.async_test
    async def test_sector_performance_attribution(self, risk_analyzer, diversified_portfolio):
    ...
    @pytest_asyncio.async_test
    async def test_stock_specific_attribution(self, risk_analyzer, diversified_portfolio):
    ...
    async def test_factor_based_attribution(self, risk_analyzer, diversified_portfolio):
        ...
        with patch.object(risk_analyzer, '_calculate_factor_exposures') as mock_exposures:
...
class TestDrawdownAnalysis:
    ...
    def test_maximum_drawdown_calculation(self, risk_analyzer):
        ...
        portfolio_values = [
            100000, 105000, 102000, 108000, 95000,   # Max drawdown here: 108000 -> 95000
            98000, 103000, 101000, 110000, 115000
        ]
    ...
    def test_underwater_period_analysis(self, risk_analyzer):
        ...
        portfolio_values = [
            100000, 95000, 90000, 88000, 92000, 89000, 94000, 98000, 101000  # Recovery
        ]
    ...
    @pytest_asyncio.async_test
    async def test_rolling_drawdown_monitoring(self, risk_analyzer, diversified_portfolio):
        """Test rolling drawdown monitoring."""
        # Mock historical portfolio values
        with patch.object(risk_analyzer, '_get_historical_portfolio_values') as mock_values:
            dates = [datetime.now() - timedelta(days=i) for i in range(30, 0, -1)]
            values = [130000 + i * 1000 + (i % 5) * 500 for i in range(30)]  # Trending up with volatility
            mock_values.return_value = list(zip(dates, values))
...
class TestRiskBudgeting:
    ...
    @pytest_asyncio.async_test
    async def test_equal_risk_contribution_portfolio(self, risk_analyzer, diversified_portfolio):
        """Test Equal Risk Contribution (ERC) portfolio construction."""
        with patch.object(risk_analyzer, '_calculate_risk_contributions') as mock_contributions:
            # Start with unequal contributions
            mock_contributions.return_value = {
                "AAPL": 0.15, "GOOGL": 0.30, "JPM": 0.25, "JNJ": 0.10, "XOM": 0.20
            }
            
            # Mock optimization to equal contributions
            target_contributions = {symbol: 0.20 for symbol in ["AAPL", "GOOGL", "JPM", "JNJ", "XOM"]}
            
            erc_weights = await risk_analyzer.calculate_erc_weights(diversified_portfolio)
    ...
    async def test_risk_parity_optimization(self, risk_analyzer, diversified_portfolio):
        ...
        with patch.object(risk_analyzer, '_optimize_risk_parity') as mock_optimize:
            mock_optimize.return_value = {
                "AAPL": 0.18, "GOOGL": 0.15, "JPM": 0.22, "JNJ": 0.28, "XOM": 0.17
            }
    ...
    @pytest_asyncio.async_test
    async def test_risk_budgeting_monitoring(self, risk_analyzer, diversified_portfolio):
        """Test ongoing risk budget monitoring."""
        target_budget = {"AAPL": 0.20, "GOOGL": 0.20, "JPM": 0.20, "JNJ": 0.20, "XOM": 0.20}
        
        with patch.object(risk_analyzer, '_calculate_current_risk_contributions') as mock_current:
            mock_current.return_value = {
                "AAPL": 0.18, "GOOGL": 0.25, "JPM": 0.19, "JNJ": 0.15, "XOM": 0.23
            }
...
class TestAdvancedRiskMetrics:
    ...
    @pytest_asyncio.async_test
    async def test_tail_dependency_analysis(self, risk_analyzer, diversified_portfolio, mock_market_data):
        """Test tail dependency analysis between positions."""
        with patch.object(risk_analyzer, '_calculate_tail_dependencies') as mock_tail_dep:
            ...
            tail_deps = await risk_analyzer.analyze_tail_dependencies(diversified_portfolio)
    ...
    @pytest_asyncio.async_test
    async def test_regime_dependent_risk_analysis(self, risk_analyzer, diversified_portfolio):
        ...
        with patch.object(risk_analyzer, '_identify_market_regime') as mock_regime:
            ...
            with patch.object(risk_analyzer, '_calculate_regime_risk_metrics') as mock_metrics:
                ...
                assert regime_analysis["bear"]["var_95"] > regime_analysis["bull"]["var_95"]
                assert regime_analysis["bear"]["var_95"] > regime_analysis["sideways"]["var_95"]
                
                # Bear market should have highest correlations
                assert regime_analysis["bear"]["correlation_avg"] > regime_analysis["bull"]["correlation_avg"]

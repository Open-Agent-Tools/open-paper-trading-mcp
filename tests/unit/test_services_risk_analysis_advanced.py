...
from app.schemas.orders import Order, OrderType, OrderCreate
...
class TestPositionConcentrationAnalysis:
    ...
    def test_position_concentration_within_limits(self, risk_analyzer, sample_portfolio):
...
class TestVolatilityRiskAnalysis:
    ...
    async def test_volatility_exposure_calculation(self, risk_analyzer, sample_portfolio, sample_quotes):
        """Test volatility exposure calculation."""
        with patch.object(risk_analyzer, '_get_historical_volatility') as mock_volatility:
...
class TestOrderImpactAnalysis:
    ...
    @pytest_asyncio.async_test
    async def test_order_impact_simulation_buy(self, risk_analyzer, sample_portfolio, sample_quotes):
    ...
    @pytest_asyncio.async_test
    async def test_order_impact_simulation_sell(self, risk_analyzer, sample_portfolio, sample_quotes):
...
class TestRiskMetricsCalculation:
    ...
    @pytest_asyncio.async_test
    async def test_comprehensive_risk_analysis(self, risk_analyzer, sample_portfolio, sample_quotes):
        ...
        with patch.object(risk_analyzer, '_get_account_info') as mock_account:
            ...
            assert result.overall_risk_level in [
                RiskLevel.LOW, RiskLevel.MODERATE, RiskLevel.HIGH, RiskLevel.EXTREME
            ]
    ...
    async def test_sector_exposure_analysis(self, risk_analyzer, sample_portfolio):
        ...
        with patch.object(risk_analyzer, '_get_sector_info') as mock_sector:
            ...
            sector_violations = [v for v in violations 
...
class TestRiskLimitCompliance:
    ...
    def test_daily_loss_limit_check(self, risk_analyzer, sample_portfolio):
        ...
        violations = risk_analyzer._check_daily_loss_limit(
...
class TestConcurrencyAndPerformance:
    ...
    @pytest_asyncio.async_test
    async def test_concurrent_risk_checks(self, risk_analyzer, sample_portfolio, sample_quotes):

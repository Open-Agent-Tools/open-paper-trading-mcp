...
@pytest.fixture
def analyzer() -> AdvancedStrategyAnalyzer:
...
@pytest.fixture
def sample_quotes() -> dict[str, Union[Quote, OptionQuote]]:
    ...
    return {
        ...
        "SPY251219C00510000": OptionQuote(
            asset=asset_factory("SPY251219C00510000"),
            quote_date=datetime.now(),
            price=9.0,
            delta=0.4,
...
def test_aggregate_strategy_greeks(
    analyzer: AdvancedStrategyAnalyzer,
    sample_positions: list[Position],
    sample_quotes: dict[str, Union[Quote, OptionQuote]],
) -> None:

...
class TestStrategyGrouping:
    ...
    def sample_positions(self):
        ...
        return [
            Position(
                symbol="AAPL", quantity=100, avg_price=150.0, asset=Asset(symbol="AAPL")
            ),
            Position(
            ...
            Position(
                symbol="SPY251219P00400000",
                quantity=1,
                avg_price=8.0,
                asset=asset_factory("SPY251219P00400000"),
            ),
        ]
    ...
    def test_group_into_basic_strategies_with_equity_only(self):
        ...
        positions = [
            Position(
                symbol="TSLA", quantity=50, avg_price=200.0, asset=Asset(symbol="TSLA")
            )
        ]
    ...
    def test_covered_call_identification(self):
        ...
        positions = [
            Position(
                symbol="MSFT", quantity=100, avg_price=300.0, asset=Asset(symbol="MSFT")
            ),
            Position(
                symbol="MSFT250620C00350000",
                quantity=-1,
                avg_price=5.0,
                asset=asset_factory("MSFT250620C00350000"),
            ),
        ]
        strategies = group_into_basic_strategies(positions)

        covered_call_found = any(
            s.strategy_type == StrategyType.COVERED for s in strategies
        )
    ...
    def test_spread_identification(self):
        ...
        positions = [
            Position(
                symbol="NVDA250321C00800000",
                quantity=1,
                avg_price=15.0,
                asset=asset_factory("NVDA250321C00800000"),
            ),
            Position(
                symbol="NVDA250321C00850000",
                quantity=-1,
                avg_price=12.0,
                asset=asset_factory("NVDA250321C00850000"),
            ),
        ]
        strategies = group_into_basic_strategies(positions)
    ...
    def test_naked_option_identification(self):
        ...
        positions = [
            Position(
                symbol="AMD250117P00150000",
                quantity=-1,
                avg_price=7.0,
                asset=asset_factory("AMD250117P00150000"),
            ),
        ]
        strategies = group_into_basic_strategies(positions)

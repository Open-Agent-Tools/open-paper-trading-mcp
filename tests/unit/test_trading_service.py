...
class TestOrderManagement:
    ...
    async def test_create_multi_leg_order_success(self, trading_service):
        ...
        mock_order_data.legs = [
            MagicMock(order_type=OrderType.BUY, quantity=1, price=1.0)
        ]
...
class TestPortfolioManagement:
    ...
    async def test_get_portfolio_success(
        self, trading_service, sample_account, sample_positions
    ):
...
class TestOptionsGreeks:
    ...
    async def test_get_portfolio_greeks_success(
        ...
        # Arrange
        mock_positions = [
            Position(symbol="AAPL240119C00150000", quantity=1, avg_price=5.0)
        ]
        ...
        mock_greeks = MagicMock(
            ...
            gamma_normalized=0.1,
            theta_normalized=-0.05,
            vega_normalized=0.2,
            delta_dollars=5000.0,
            gamma_dollars=1000.0,
            theta_dollars=-500.0,
        )
    ...
    @patch("app.services.trading_service.asset_factory")
    @patch("app.services.trading_service.calculate_option_greeks")
    def test_calculate_greeks_success(
        self, mock_calc_greeks, mock_asset_factory, trading_service
    ):
...
class TestOptionsData:
    ...
    def test_get_options_chain_success(self, trading_service):
        ...
        trading_service.quote_adapter.get_options_chain = MagicMock(
    ...
    def test_find_tradable_options_error(self, trading_service):
        ...
        # Arrange
        symbol = "AAPL"
        trading_service.get_options_chain = MagicMock(
    ...
    @patch("app.services.trading_service.asset_factory")
    def test_get_option_market_data_invalid_symbol(
    ...
    def test_get_expiration_dates_success(self, trading_service):
        ...
        trading_service.quote_adapter.get_expiration_dates = MagicMock(
        ...
        trading_service.quote_adapter.get_expiration_dates.assert_called_once_with(
            underlying
        )
...
class TestOptionsStrategy:
    ...
    def test_analyze_portfolio_strategies_comprehensive(self, trading_service):
        ...
        mock_strategies = [
            MagicMock(dict=MagicMock(return_value={"type": "long_call"}))
        ]
        mock_summary = {"long_call": 1}

        trading_service.strategy_recognition.group_positions_by_strategy = MagicMock(
            return_value=mock_strategies
        )
        trading_service.strategy_recognition.get_strategy_summary = MagicMock(
    ...
    def test_simulate_expiration_success(self, mock_asset_factory, trading_service):
        ...
        mock_position = Position(
            symbol="AAPL240119C00150000", quantity=1, avg_price=5.0
        )
        mock_portfolio = Portfolio(
            cash_balance=10000.0,
    ...
    def test_simulate_expiration_error_handling(self, trading_service):
        ...
        # Arrange
        trading_service.get_portfolio = MagicMock(
...
class TestMarketData:
    ...
    def test_get_price_history_success(self, mock_asset_factory, trading_service):
        ...
        trading_service.quote_adapter.get_price_history = MagicMock(
    ...
    def test_get_top_movers_success(self, trading_service):
        ...
        # Arrange
        mock_movers = {"movers": [{"symbol": "AAPL", "change_percent": 5.0}]}
        trading_service.quote_adapter.get_top_movers = MagicMock(
            return_value=mock_movers
        )
    ...
    def test_get_top_movers_fallback(self, trading_service):
        ...
        # Arrange
        trading_service.get_available_symbols = MagicMock(
            return_value=["AAPL", "GOOGL"]
        )
        trading_service.get_stock_price = MagicMock(
            return_value={"price": 150.0, "change_percent": 2.0}
        )
    ...
    def test_search_stocks_success(self, trading_service):
        ...
        trading_service.quote_adapter.search_stocks = MagicMock(
...
class TestDatabaseInteraction:
    ...
    def test_ensure_account_exists_creates_account(
        self, mock_session_local, trading_service
    ):
    ...
    @patch("app.services.trading_service.SessionLocal")
    def test_ensure_account_exists_account_exists(
        self, mock_session_local, trading_service
    ):
...
class TestUtilityMethods:
    ...
    def test_validate_account_state_success(self, trading_service):
        ...
        # Arrange
        trading_service.account_validation.validate_account_state = MagicMock(
            return_value=True
        )
    ...
    def test_get_test_scenarios(self, trading_service):
        ...
        trading_service.quote_adapter.get_test_scenarios = MagicMock(
    ...
    def test_get_available_symbols(self, trading_service):
        ...
        trading_service.quote_adapter.get_available_symbols = MagicMock(
    ...
    def test_get_sample_data_info(self, trading_service):
        ...
        trading_service.quote_adapter.get_sample_data_info = MagicMock(

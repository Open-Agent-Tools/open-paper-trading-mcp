...
from app.models.trading import OrderCreate, OrderType, OrderStatus
...
class TestTradingService:
    ...
    def test_get_orders_with_data(self):
        ...
        # Create a few orders
        order_data1 = OrderCreate(symbol="AAPL", order_type=OrderType.BUY, quantity=10, price=150.0)
        order_data2 = OrderCreate(symbol="GOOGL", order_type=OrderType.SELL, quantity=5, price=2800.0)
    ...
    def test_get_order_success(self):
        ...
        order_data = OrderCreate(symbol="AAPL", order_type=OrderType.BUY, quantity=10, price=150.0)
